...
-- theme_path = "~/.config/awesome/themes/xcession"
...
text_battery = widget({ type = "textbox", name = "text_battery", align = "right" })
...
function hook_timer ()
    ...
    text_battery.text = " " .. get_command_output("~/bin/battery") .. " "
end
