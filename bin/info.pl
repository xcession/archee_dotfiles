...
my %display = (
                ...
                "WMT"       => 0, # Displays your window manager's theme
                "IC"        => 0, # Displays your icon theme, if you have one
                "FN"        => 0, # Displays your font 
                "UI"        => 0  # Displays your UI theme
              );
...
########################
@distros = ();
require '/home/xcession/bin/logos.pl';
